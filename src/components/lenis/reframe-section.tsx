export default function ReframeSection() {
    return (
        <>
            <section className='text-white  h-screen  w-full bg-[#1F1642]  grid place-content-center sticky top-0'>
                ...
                <h1 className='2xl:text-7xl text-5xl px-8  text-center font-anton tracking-wide uppercase leading-[0.9]'>
                    Stop Hiring Help.
                    <br />
