...
export default function HeroSection() {
    return (
        <section className='bg-transparent text-white min-h-screen w-full grid place-content-center relative overflow-hidden'>
            {/* Spotlight Effect */}
            <Spotlight
            ...
            <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center space-y-8 max-w-5xl mx-auto">
                ...
                >
                    Talent <span className="text-blue-200">Mucho</span>: <br />
