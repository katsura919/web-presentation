...
export default function StagesSection() {
    ...
    return (
        <>
            <section className='text-white w-full bg-slate-950 grid place-content-center dark relative'>
                ...
                <div className="pt-10 text-center container px-4 bg-slate-950">
                    <h1 className="text-4xl md:text-5xl font-bold font-serif mb-6">The 3-Stage Evolution of Your Agency</h1>
